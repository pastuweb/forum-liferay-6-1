...
/**
 * The base implementation of the forum user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.appuntivari.forum.service.impl.ForumUserLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ForumUserLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ForumUserLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link net.appuntivari.forum.service.ForumUserLocalServiceUtil} to access the forum user local service.
	 */
	...
	public ForumUser addForumUser(ForumUser forumUser)
		throws SystemException {
		forumUser.setNew(true);

		return forumUserPersistence.update(forumUser, false);
	}
	 ...
	 */
	public ForumUser createForumUser(long id_forum_user) {
		return forumUserPersistence.create(id_forum_user);
	}
	...
	public ForumUser deleteForumUser(long id_forum_user)
		throws PortalException, SystemException {
		return forumUserPersistence.remove(id_forum_user);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ForumUser deleteForumUser(ForumUser forumUser)
		throws SystemException {
		return forumUserPersistence.remove(forumUser);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(ForumUser.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return forumUserPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return forumUserPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return forumUserPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ForumUser fetchForumUser(long id_forum_user)
		throws SystemException {
		return forumUserPersistence.fetchByPrimaryKey(id_forum_user);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ForumUser getForumUser(long id_forum_user)
		throws PortalException, SystemException {
		return forumUserPersistence.findByPrimaryKey(id_forum_user);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return forumUserPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ForumUser> getForumUsers(int start, int end)
		throws SystemException {
		return forumUserPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getForumUsersCount() throws SystemException {
		return forumUserPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ForumUser updateForumUser(ForumUser forumUser)
		throws SystemException {
		return updateForumUser(forumUser, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ForumUser updateForumUser(ForumUser forumUser, boolean merge)
		throws SystemException {
		forumUser.setNew(false);

		return forumUserPersistence.update(forumUser, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("net.appuntivari.forum.model.ForumUser",
			forumUserLocalService);
	}
	...
	private ForumUserLocalServiceClpInvoker _clpInvoker = new ForumUserLocalServiceClpInvoker();
}