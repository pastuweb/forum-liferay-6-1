 ...
 */
public class ForumLocalServiceClp implements ForumLocalService {
	public ForumLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName19 = "getNewForum";

		_methodParameterTypes19 = new String[] {  };

		_methodName20 = "createForumAdHoc";

		_methodParameterTypes20 = new String[] {
				"net.appuntivari.forum.model.Forum"
			};

		_methodName21 = "getForumsByCompanyId";
	...
	public net.appuntivari.forum.model.Forum addForum(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(forum) });
		}
		catch (Throwable t) {
	...
	public net.appuntivari.forum.model.Forum createForum(long id_forum) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { id_forum });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public net.appuntivari.forum.model.Forum deleteForum(long id_forum)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { id_forum });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public net.appuntivari.forum.model.Forum fetchForum(long id_forum)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName9,
					_methodParameterTypes9, new Object[] { id_forum });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public net.appuntivari.forum.model.Forum getForum(long id_forum)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { id_forum });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public net.appuntivari.forum.model.Forum updateForum(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(forum), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<net.appuntivari.forum.model.Forum> getForumsByCompanyId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName21,
					_methodParameterTypes21, new Object[] { company_id });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
