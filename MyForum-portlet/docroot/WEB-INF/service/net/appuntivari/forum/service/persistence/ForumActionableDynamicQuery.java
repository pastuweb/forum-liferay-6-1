 ...
 * @generated
 */
public abstract class ForumActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ForumActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ForumLocalServiceUtil.getService());
		setClass(Forum.class);

		setClassLoader(net.appuntivari.forum.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("id_forum");
	}
}