 ...
 * @generated
 */
public abstract class ForumUserActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ForumUserActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ForumUserLocalServiceUtil.getService());
		setClass(ForumUser.class);

		setClassLoader(net.appuntivari.forum.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("id_forum_user");
	}
}