 ...
 */
public class ForumPostLocalServiceClp implements ForumPostLocalService {
	public ForumPostLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName19 = "getNewForumPost";

		_methodParameterTypes19 = new String[] {  };

		_methodName20 = "createForumPostAdHoc";

		_methodParameterTypes20 = new String[] {
				"net.appuntivari.forum.model.ForumPost"
			};

		_methodName21 = "getForumPostsByTimestamp";

		_methodParameterTypes21 = new String[] { "java.util.Date" };

		_methodName22 = "getForumPostsByUserId";

		_methodParameterTypes22 = new String[] { "long" };

		_methodName23 = "getForumPostsByUserIdPostParent";
	...
	public net.appuntivari.forum.model.ForumPost addForumPost(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(forumPost) });
		}
		catch (Throwable t) {
	...
	public net.appuntivari.forum.model.ForumPost createForumPost(long id_post) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { id_post });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public net.appuntivari.forum.model.ForumPost deleteForumPost(long id_post)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { id_post });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public net.appuntivari.forum.model.ForumPost fetchForumPost(long id_post)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName9,
					_methodParameterTypes9, new Object[] { id_post });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public net.appuntivari.forum.model.ForumPost getForumPost(long id_post)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { id_post });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public net.appuntivari.forum.model.ForumPost updateForumPost(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(forumPost), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<net.appuntivari.forum.model.ForumPost> getForumPostsByUserId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName22,
					_methodParameterTypes22, new Object[] { user_id });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<net.appuntivari.forum.model.ForumPost> getForumPostsByUserIdPostParent(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName23,
					...
					new Object[] { user_id_post_parent });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<net.appuntivari.forum.model.ForumPost> getForumPostsRootByIdCategory(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName24,
					_methodParameterTypes24, new Object[] { id_category });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
